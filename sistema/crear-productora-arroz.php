...
<head>
    ...
    <title> Crear productora de arroz</title>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> NUEVA PRODUCTORA DE ARROZ </h4>
                                </div>
                                <div class="card-body">
                                    <form id="frmProductoraArroz" method="post">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#btnAgregar').click(function() {
                ...
                var formData = new FormData($("#frmProductoraArroz")[0]);
                ...
                $.ajax({
                    type: "POST",
                    url: "php/productoraArroz/productoraArroz.php",
                    dataType: 'json',
                    data: formData,
                    cache: false,
                    contentType: false,
                    ...
                    success: function(response) {
                        ...
                        if (response['status'] == 'correcto') {
                            document.getElementById("frmProductoraArroz").reset();
